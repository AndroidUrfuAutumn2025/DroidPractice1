    ...
    DroidPractice1Theme {
        Scaffold(
            ...
            Column(
                ...
                Text(
                    text = "Короткий подзаголовок",
                    fontStyle = FontStyle.Italic,
                    textAlign = TextAlign.Start
                )
                Spacer(Modifier.height(12.dp))
                AsyncImage(
                    model = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS1tMCND-m1iw7Ys7BtOYJc3yrnlRPeT5xpFg&s",
                ...
                Spacer(Modifier.height(12.dp))
                Text(
                    text = "Длинный текст статьи... ".repeat(24),
